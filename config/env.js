...
export const CONTACT_SMTP_FROM=isProduction ? 'contactus@thespotlightsystem.com' : 'munna@ferventsoft.com';
export const SMTP_HOST = isProduction ? 'smtp.gmail.com' : 'smtp.ferventsoft.com';
export const SMTP_PORT = isProduction ? 465 : 587;
export const SMTP_USERNAME = isProduction ? 'noreply@thespotlightsystem.com' : 'sl@ferventsoft.com';
export const SMTP_PASSWORD = isProduction ? 'gunr1014' : 'Spotlight@123';
...
export const SMTP_SECURE = isProduction ? true : false;
